...
var addressModal = {
	...
	bindEvent : function(){
		...
		this.$modalWrap.find('.address-btn').click(function(){
			...
			//验证不通过
				...
				_pf.errorTips(receiverInfo.errMsg || '好像哪里不对了');
			}
		});
	...
	loadModal : function(){
		var addressModalHtml = _pf.renderHtml(templateAddressModal,{
